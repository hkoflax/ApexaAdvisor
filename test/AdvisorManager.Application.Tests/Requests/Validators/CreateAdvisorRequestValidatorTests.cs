...
{
    public class CreateAdvisorRequestValidatorTests
    {
        private readonly CreateAdvisorRequestValidator _validator;

        public CreateAdvisorRequestValidatorTests()
        {
            _validator = new CreateAdvisorRequestValidator();
        }
        ...
        public void Should_UseAdvisorDtoValidator_When_DetailsIsSet()
        {
            ...
            var request = new CreateAdvisorRequest(invalidAdvisorDto);
